...
| L2 | **Canonical spec** | [`skills/_shared/jira-api-reference.md`](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/skills/_shared/jira-api-reference.md) §12–§13 | The machine-facing interface: the regex, the prefix table, the prefix/base sanity table. |
...
type system, and no test suite — [AGENTS.md](https://github.com/kantorv/jira-sdlc-tools/blob/main/AGENTS.md) says so
...
[AGENTS.md](https://github.com/kantorv/jira-sdlc-tools/blob/main/AGENTS.md) (`STATUSCHECK_FORCE_OS=windows`, diff each
