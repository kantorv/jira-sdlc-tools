...
**[Driving Jira state from GitHub Actions](../github/STATE-TRANSITIONS-WITH-GITHUB-ACTIONS.md)**.
...
**[rest-client-design.md](../history/rest-client-design.md)** (why `jira.sh` exists in
