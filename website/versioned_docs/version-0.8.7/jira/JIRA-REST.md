...
- [`scripts/posix/create_parent_and_subtasks.sh`](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/skills/_shared/scripts/posix/create_parent_and_subtasks.sh)
...
- [`scripts/posix/list_subtasks.sh`](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/skills/_shared/scripts/posix/list_subtasks.sh)
