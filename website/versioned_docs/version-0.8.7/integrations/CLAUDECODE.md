...
model — see the plugin's own [README.md](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/README.md). This page is only
...
> [README.md](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/README.md) for the other places a plugin rename has to
> be followed through.
