...
> **Stub — TBD.** Until this page is written, the upstream install guide is
> [github/github-for-jira](https://github.com/github/github-for-jira), and
> Atlassian's own integration doc is
> [here](https://support.atlassian.com/jira-cloud-administration/docs/integrate-jira-software-with-github/).
...
- Non-GitHub forges — see the plugin [README.md](https://github.com/kantorv/jira-sdlc-tools/blob/main/plugins/jira-sdlc/README.md) → Known
